...
frappe.ui.form.on("Purchase Receipt Item", {
    ...
    custom_length: recalculate_row,
    custom_width: recalculate_row,
    custom_thickness: recalculate_row,
    custom_outer_diameter: recalculate_row,
    custom_inner_diameter: recalculate_row,
    custom_wall_thickness: recalculate_row,
    custom_density: recalculate_row,

    custom_scrap_margin_percentage: recalculate_row,
    custom_transportation_cost: recalculate_row,
